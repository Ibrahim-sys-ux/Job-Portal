...
if (isset($_POST['sub'])) {
	extract($_POST);
    if($pass==$cpass){
	$q="insert into login values(null,'$uname','$pass','pending')";
	$lid=insert($q);
	$p="insert into employee values(null,'$lid','$fname','$lname','$phone','$email')";
	$uid=insert($p);
                ...
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            <h1 class="display-3 text-white animated slideInDown mb-4" align="center">EMPLOYEE REGISTERATION</h1>
        ...
        <table align="center" class="table" style="width:500px">
           ...
           <tr>
			...
			<tr>
				...
				<td><input type="phone" name="phone" min=10 max=10  required class="form-control"></td>
			</tr>
			<tr>
